...
class IPOObjectAnimation {
    locationX: IPOCurve = null;
    locationY: IPOCurve = null;
    locationZ: IPOCurve = null;
    rotationX: IPOCurve = null;
    rotationY: IPOCurve = null;
    rotationZ: IPOCurve = null;
    scalingX: IPOCurve = null;
    scalingY: IPOCurve = null;
    scalingZ: IPOCurve = null;
}
...
class AnimationSolver {
    ...
    getIPOCurveValueIfNotNull(ipoCurve: IPOCurve, time: float, defaultValue: float): float {
