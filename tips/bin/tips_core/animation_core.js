    ...
    AnimationSolver.prototype.getIPOCurveValue = function (ipoCurve, time) {
        ...
        if (sectionIndex < ipoCurve.curve.length - 1) {
            if (ipoCurve.ipoType == IPOCurveIPOTypes.Bezier) {
                ...
                interpolatedValue = this.calcInterpolationLiner(ipoCurve.curve[sectionIndex][1][1], ipoCurve.curve[sectionIndex + 1][1][1], timeInSection);
            }
        }
        return interpolatedValue;
    };
    AnimationSolver.prototype.getIPOCurveValueIfNotNull = function (ipoCurve, time, nullAlternateValue) {
...
//# sourceMappingURL=animation_core.js.map